...
export default function Music(){
    //  Declaring The Songs Details using state
    ...
    //  function to pause and play the music
    ...
    //  functions to change the songs, either pass to the next one or go back to the prev one
    ...
    // function to update the music details (name, artist...)
